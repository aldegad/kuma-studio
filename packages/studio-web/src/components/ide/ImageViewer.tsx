...
export function ImageViewer({ content, mimeType, filePath, onClose }: ImageViewerProps) {
  ...
  return (
    ...
    >
      <div
        className="relative mx-4 flex max-h-[85vh] w-full max-w-3xl flex-col overflow-hidden rounded-xl border border-stone-200/80 bg-white shadow-[0_25px_60px_-15px_rgba(0,0,0,0.3)]"
