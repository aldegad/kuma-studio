...
- Managed reload/restart should re-discover and re-register a live `kuma-server` title surface in the current workspace before giving up on a registry miss.
